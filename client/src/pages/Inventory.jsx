    ...
    return (
        <>
            <div className="m-3 flex items-center justify-center bg-green-200">
                <div className="w-full text-5xl text-center text-green-500 bg-pink-300 py-2 font-bold">Sample Inventory</div>
            </div>

            <div className="m-3 flex items-center justify-center bg-green-200">
                <table className="border-2 border-green-400 bg-pink-300">
                    <thead>
                        <tr>
                            <th className="text-green-600">Product ID</th>
                            <th className="text-green-600">Product Name</th>
                            <th className="text-green-600">Quantity</th>
                            <th className="text-green-600">Unit</th>
                            <th className="text-green-600">Price</th>
                            <th className="text-green-600">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        {
                                ...
                                <tr key={index}>
                                    ...
                                    <td>
                                        <button
                                            ...
                                            className="mr-2 border-2 border-blue-500 p-2 rounded bg-green-400 text-white hover:bg-blue-500"
                                        >
                                            Edit
                                        </button>
                                        <button
                                            onClick={() => handleDelete(element.product_id)}
                                            className="border-2 border-red-500 p-2 rounded bg-pink-400 text-white hover:bg-red-500"
                                        >
                                            Delete
                                        </button>
                                    </td>
                ...
                {isModalOpen && (
                    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                        <div className="bg-pink-300 p-8 rounded-md shadow-md w-1/3">
            ...
            <div className="m-3 flex items-center justify-center">
                <button
                    type="button"
                    className="p-2 rounded bg-green-400 border border-pink-400 text-white hover:bg-pink-400 hover:border-green-400"
